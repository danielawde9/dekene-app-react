    ...
    return (
        <Card title="Credits">
            <Form form={form} onFinish={onFinish}>
                ...
                <Form.Item name="person" label="Person" rules={[{ required: true, message: 'Please input the person!' }]}>
                    <Input />
                </Form.Item>
                <Form.Item>
            ...
            <Table dataSource={credits} columns={columns(handleDelete)} rowKey="key" />
        </Card>
    );
}
